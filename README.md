...
- **Removal of old encryption methods**: The previous encryption methods AES, AES-CCM, and CTR have been completely removed.
- **Exclusive use of XChaCha20-Poly1305**: The project now exclusively uses the modern XChaCha20-Poly1305 AEAD encryption for increased security and better performance.
- **CryptoEngine class revised**: Extensive adjustments to the CryptoEngine class to support the new encryption standard.
- **Codebase cleanup**: Removal of old source code files and legacy code to improve maintainability.
